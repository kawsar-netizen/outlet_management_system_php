          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
				...
				elseif(isset($_GET['tag_number']) and ($_GET['tag_number']=='' or $_GET['tag_number']!='152'))
				{
				?>
				<form role="form" action="" method="">
                  <div class="box-body">
				...
				if(isset($_GET['tag_number']) and $_GET['tag_number']!='' and $_GET['tag_number']=='152')
				{
				?>
                <form role="form" action="outlet_list.php" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="outlet_name" name="outlet_name" placeholder="Enter the Tag Number" value="152" readonly>
                    </div>
                    <div class="form-group">
                      <label for="outlet_location">Asset Description</label>
                      <input type="text" class="form-control" id="outlet_location" name="outlet_location" placeholder="Description" value="Samsung Notebook" readonly>
                    </div>
					<div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="size" name="size" placeholder="" value="300E4C" readonly>
                    </div>
					<div class="form-group">
                      <label for="increase_percentage">Brand Name</label>
                      <input type="text" class="form-control" id="increase_percentage" name="increase_percentage" placeholder="" value="Samsung" readonly>
                    </div>
					<div class="form-group">
                      <label for="increase_percentage">Assained Branch Name</label>
                      <input type="text" class="form-control" id="increase_percentage" name="increase_percentage" placeholder="" Value="Taltola Branch,Khilgaon" readonly>
                    </div>
			...
			<div class="col-md-6">
              <div class="box">
                <div class="box-header"><h4>Issued Asset List</h4></div><!-- /.box-header -->
