        ...
        <table id="attendance_list" class="table table-bordered table-striped">
          ...
          <tbody class="scroll-pane">
            ...
            if ($_SESSION['role_id'] == 2) {
              $branch_query = "WHERE branch = 'infinity Baily Road'";
            }
            $query = "SELECT * FROM `attendance_table` $branch_query ORDER BY id DESC";
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-body no-padding">
          <table id="asset_list" class="table table-bordered table-striped">
          <thead>
            <tr>
              <th>SL.</th>
                <th>tag_number</th>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box-body table-responsive">
          <table id="kawsar_branch" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>SL.</th>
                <th>Brand Name</th>
