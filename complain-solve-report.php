...
<div class="content-wrapper">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Maintanance solve</li>
        </ol>
    </section>
    <section class="content" style="margin-top: 20px;">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form action="complain-solve-report-show.php" method="GET">
                    <div class="row">
                        <div class="form-group col-md-6 mt-1">
                            <label for="owner_des">Select asset tag name</label>
                            <select class="form-control select2" style="width: 100%;" name="asset" id="asset">
                        ...
                        <div class="col-md-6 form-group mt-1">
                            <label for="owner_des">Select branch name</label>
